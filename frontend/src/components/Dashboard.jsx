...
const Dashboard = () => {
  const [data, setdata, presenteddata, setpresenteddata] =
  ...
  return (
    <>
      <div className=" sm:grid grid-cols-[30%_70%] mt-3 pl-1.5 pr-1.5">
          ...
          {mockStockData.map((e) => {
            ...
            return (
              <div
                onClick={handeldata}
                id={e.symbol}
                className={`flex justify-between p-2.5 m-4 text-white ${
              ...
              >
                ...
                <p
                  className={`${
                    ispositveValue ? "text-green-500" : "text-red-600"
                  }`}
                >
                  {e.price} <br /> {e.change}
                </p>
        ...
        <div className="bg-slate-800 border-2  m-3 p-5">
          <StockDataTable />
        </div>
      </div>
